...
enum bind_action_vim {
    ...
    BIND_ACTION_VIM_FIRST,
    BIND_ACTION_VIM_LAST,
    BIND_ACTION_VIM_FIRST_OCCUPIED,
    BIND_ACTION_VIM_HIGH,
    BIND_ACTION_VIM_MIDDLE,
    BIND_ACTION_VIM_LOW,
    BIND_ACTION_VIM_SEMANTIC_LEFT,
    BIND_ACTION_VIM_SEMANTIC_RIGHT,
    BIND_ACTION_VIM_SEMANTIC_LEFT_END,
    BIND_ACTION_VIM_SEMANTIC_RIGHT_END,
    BIND_ACTION_VIM_WORD_LEFT,
    BIND_ACTION_VIM_WORD_RIGHT,
    BIND_ACTION_VIM_WORD_LEFT_END,
    BIND_ACTION_VIM_WORD_RIGHT_END,
    BIND_ACTION_VIM_BRACKET,
    BIND_ACTION_VIM_PARAGRAPH_UP,
    BIND_ACTION_VIM_PARAGRAPH_DOWN,
    BIND_ACTION_VIM_SCROLLBACK_UP_PAGE,
    BIND_ACTION_VIM_SCROLLBACK_UP_HALF_PAGE,
    BIND_ACTION_VIM_SCROLLBACK_UP_LINE,
    BIND_ACTION_VIM_SCROLLBACK_DOWN_PAGE,
    BIND_ACTION_VIM_SCROLLBACK_DOWN_HALF_PAGE,
    BIND_ACTION_VIM_SCROLLBACK_DOWN_LINE,
    BIND_ACTION_VIM_SCROLLBACK_HOME,
    BIND_ACTION_VIM_SCROLLBACK_END,
    BIND_ACTION_VIM_CENTER_CURSOR,
    BIND_ACTION_VIM_TOGGLE_NORMAL_SELECTION,
    BIND_ACTION_VIM_TOGGLE_LINE_SELECTION,
    BIND_ACTION_VIM_TOGGLE_BLOCK_SELECTION,
    BIND_ACTION_VIM_TOGGLE_SEMANTIC_SELECTION,
    BIND_ACTION_VIM_CLEAR_SELECTION,
    BIND_ACTION_VIM_COPY,
    BIND_ACTION_VIM_COPY_TO_END_OF_LINE,
