...
enum bind_action_vim {
    ...
    BIND_ACTION_VIM_SCROLL_CURSOR_TO_TOP,
    BIND_ACTION_VIM_SCROLL_CURSOR_TO_BOTTOM,
    ...
    BIND_ACTION_VIM_INLINE_SEARCH_FORWARD,
    BIND_ACTION_VIM_INLINE_SEARCH_BACKWARD,
    BIND_ACTION_VIM_INLINE_SEARCH_FORWARD_SHORT,
    BIND_ACTION_VIM_INLINE_SEARCH_BACKWARD_SHORT,
    BIND_ACTION_VIM_INLINE_SEARCH_NEXT,
    BIND_ACTION_VIM_INLINE_SEARCH_PREVIOUS,
    BIND_ACTION_VIM_SEARCH_START,
    BIND_ACTION_VIM_SEARCH_START_BACKWARD,
    BIND_ACTION_VIM_SEARCH_NEXT,
    BIND_ACTION_VIM_SEARCH_PREVIOUS,
